...
<<<<<<< HEAD
    ...
    const addingArr = [];
    arr.forEach(Element => {
        addingArr.push(Element + 2)
    })
    return addingArr;
=======
  // Solution code here...
>>>>>>> fd9f16273ee5801cb00dfb334fcdc27b364861eb
}
...
<<<<<<< HEAD
    // Solution code here...
    const lowerCase = /world/g;
    return (lowerCase.test(input));
=======
  // Solution code here...
  let checkWorld = /world/g
  return(checkWorld.test(input))
>>>>>>> fd9f16273ee5801cb00dfb334fcdc27b364861eb
};
...
<<<<<<< HEAD
    // Solution code here...
    const citiesArr = [];
    const specificLetter = /^[A-J](\w)*/;
    arr.forEach(Element => {
        if (specificLetter.test(Element)) {
